...
if (
  typeof process.env.NEXT_SUPABASE_PROJECT_URL !== "undefined" &&
  typeof process.env.NEXT_SUPABASE_API_KEY !== "undefined"
) {
  const url = process.env.NEXT_SUPABASE_PROJECT_URL;
  const key = process.env.NEXT_SUPABASE_API_KEY;
